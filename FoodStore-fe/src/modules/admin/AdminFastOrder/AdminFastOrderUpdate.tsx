...
import { fastOrderStatusOption } from '../config/fastOrder'

const AdminFastOrderUpdate = ({ data, handleCancel, handleOk }: ModalProps<IOrderResponse, OrderStatus>) => {
...
export default AdminFastOrderUpdate