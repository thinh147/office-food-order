...
import { columnsCart } from '../../admin/config/fastOrder';

const ShipperFastOrderCart = ({ data, handleCancel, handleOk }: ModalProps<IOrderResponse & { type: OrderType }, unknown>) => {
...
export default ShipperFastOrderCart